...
int obter_ou_modificar_elemento(tLista *lista, int novoValor, int posicao, bool modificar);
...
int main(void) {
  ...
  while (opcao != 0) {
    ...
    case 5:
      ...
      obter_ou_modificar_elemento(&lista, novoElementoModificado, posicaoModificar, modificar);
